...
<body ontouchstart>
	<header class="demos-header">
		<h1 class="demos-title">演唱会抽奖报名</h1>
    </header>
    <div class="page__bd">
    	<article class="weui-article">
    		<section>
    			<p>苏宁-1月12日罗志祥佛山演唱会门票抽奖报名</p>  
    		</section>
    		...
    		<div class="weui-cells weui-cells_form">    			
    			...
    			<div class="weui-cell">
    				<div class="weui-cell__hd"><label class="weui-label">身份证后8位</label></div>
    				<div class="weui-cell__bd">    					
    					<input class="weui-input" id="idno" placeholder="只需填后8位">
    				</div>    				
    			</div>
    			<div class="weui-cell">
	...
	<script>
		...
		$("#idno").on("blur",function(){
			var idno=$("#idno").val();
			var re = new RegExp("(\\d{7})([0-9]|X|x)");
			var r=re.exec(idno);
			if(r==null){
				showMessage("格式错误","身份证后8位");
				//$("#idno").focus();				
			}
			else{
				check++;
